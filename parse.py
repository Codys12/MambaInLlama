...
def parse_file(filename):
    ...
    data = defaultdict(lambda: {'attn': [], 'mamba': [], 'combined': [], 'distance': []})
...
def save_to_csv(data, filename):
    with open(filename, 'w', newline='', encoding='utf-8') as file:
        ...
        writer.writerow(['Percentage', 'Avg Attn Magnitude', 'Avg Mamba Magnitude', 'Avg Combined Magnitude', 'Avg Distance'])
...
def main():
    input_file = 'data.txt'
    output_file = 'magnitude_and_distance_averages.csv'
